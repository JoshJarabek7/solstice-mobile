...
struct ShareButton: View {
    ...
    init(title: String, image: String, foregroundColor: Color = .primary, action: @escaping () -> Void) {
        self.title = title
        self.image = image
        self.systemImage = nil
    ...
    init(title: String, systemImage: String, foregroundColor: Color = .primary, action: @escaping () -> Void) {
        self.title = title
        self.image = nil
